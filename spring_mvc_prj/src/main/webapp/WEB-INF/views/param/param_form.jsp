...
<body>
<form method="get" id="getFrm" action="http://localhost/spring_mvc_prj/param/param_form_process.do">
<label>이름</label>
...
<form method="post" id="postFrm" action="http://localhost/spring_mvc_prj/param/param_form_process.do">
<label>이름</label>
<input type="text" name="name"/><br/>
<label>취미</label>
<input type="checkbox" name="hobby" value="영화"/>영화감상<br/>
